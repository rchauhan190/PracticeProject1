...
import defaultImage from "../../../public/user.jpg"; // Default image

export default function EditProfile() {
  const [profile, setProfile] = useState({});
  const [image, setImage] = useState(defaultImage); // Use default image initially
  ...
  const handleImageUpload = async () => {
    ...
    try {
      ...
      const permanentImageUrl = response.data.data.managerImage; 
  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: "flex", flexDirection: "row-reverse", gap: "16px", margin: "14px" }}>
        <Button
